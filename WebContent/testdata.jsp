		...
		<div class="container">
			<div class="row" style="padding-top: 50px;">
				...
				<div class="col-lg-12 intro_col">
					...
					<div class="intro_form_title">Upload Kidney Test Report</div>
						<form action="uktr.jsp" method="post" class="intro_form" id="intro_form">
							<div class="d-flex flex-row align-items-start justify-content-between flex-wrap">
								...
								<input type="text" name="AL" class="intro_input" placeholder="AL" required="required" style="width: 49%">
								<input type="text" name="SU" class="intro_input" placeholder="SU" required="required" style="width: 49%">
								<input type="text" name="RBC" class="intro_input" placeholder="RBC" required="required" style="width: 49%">
								<input type="text" name="PC" class="intro_input" placeholder="PC" required="required" style="width: 49%">
								<input type="text" name="PCC" class="intro_input" placeholder="PCC" required="required" style="width: 49%">
								<input type="text" name="BA" class="intro_input" placeholder="BA" required="required" style="width: 49%">
								...
								<input type="text" name="HTN" class="intro_input" placeholder="HTN" required="required" style="width: 49%">
								<input type="text" name="DM" class="intro_input" placeholder="DM" required="required" style="width: 49%">
								<input type="text" name="CAD" class="intro_input" placeholder="CAD" required="required" style="width: 49%">
								<input type="text" name="APPET" class="intro_input" placeholder="APPET" required="required" style="width: 49%">
								<input type="text" name="PE" class="intro_input" placeholder="PE" required="required" style="width: 49%">
								<input type="text" name="ANE" class="intro_input" placeholder="ANE" required="required" style="width: 49%">							
							</div>
