		...
		<div class="header_content d-flex flex-row align-items-center jusity-content-start trans_400">
			...
			<nav class="main_nav">
				<ul class="d-flex flex-row align-items-center justify-content-start">
					...
					<li><a href="hospital.jsp">Logout</a></li>
				</ul>
			</nav>
		...
		<div class="container">
			<div class="row" style="padding-top: 50px;">
				...
				<div class="col-lg-12 intro_col">
					...
					<div class="intro_form_title">Hospital Details Data</div>
						<form action="uploadhdata.jsp" method="post" class="intro_form" id="intro_form">
							<div class="d-flex flex-row align-items-start justify-content-between flex-wrap">
								<input type="text" name="hname" class="intro_input" placeholder="Hospital Name" required="required" style="width: 49%">
								<input type="text" name="spl" class="intro_input" placeholder="Facility Name" required="required" style="width: 49%">
