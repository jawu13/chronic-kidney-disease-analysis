		...
		<div class="container">
			<div class="row" style="padding-top: 50px;">
				...
				<div class="col-lg-6 intro_col">
					<div>
					<img alt="" src="img/many-people.jpg" style="width: 80%; height: 80%; background-size: 100%100%">	
					</div>
				</div>

				<div class="col-lg-6 intro_col">
					<div class="intro_form_container">
						<div class="intro_form_title">People Register Here</div>
						<form action="registerdb.jsp" method="post" class="intro_form" id="intro_form">
