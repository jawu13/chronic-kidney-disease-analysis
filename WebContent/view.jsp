		...
		<div class="container">
			<div class="row" style="padding-top: 50px;">
				...
				<div class="col-lg-12 intro_col">
					...
					<div class="intro_form_title">Registration Data</div>
						<form action="update.jsp" method="post" class="intro_form" id="intro_form">
							...
							try
							{
								...
								while(rs.next())
								{
									...
									<td><a href="fview.jsp?id=<%=rs.getString("id") %>">view</a></td>
									</tr>							
									<%
								}
							}
